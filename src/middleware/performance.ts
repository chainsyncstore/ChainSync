 ...
 */
export const cacheMiddleware = (ttlSeconds: number = CACHE_CONFIG.TTL.API_RESPONSE) => {
  return async (req: Request, res: Response, next: NextFunction) => {
    ...
    try {
      ...
      if (cachedResponse) {
        logger.debug('Cache hit for API response', { path: req.path });
 ...
 */
export const adaptiveRateLimitMiddleware = (req: Request, res: Response, next: NextFunction) => {
 ...
 */
export const performanceErrorMiddleware = (error: Error, req: Request, res: Response, next: NextFunction) => {
