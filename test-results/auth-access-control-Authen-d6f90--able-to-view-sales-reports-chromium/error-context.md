...
- Name: Authentication and Access Control >> Access Control >> only manager or admin should be able to view sales reports
- Location: C:\Users\USER\Downloads\ChainSync Directory\ChainSyncManager\test\e2e\auth-access-control.spec.ts:125:5
...
Call log:
  - waiting for locator('input[name="email"]')
    ...
    at C:\Users\USER\Downloads\ChainSync Directory\ChainSyncManager\test\e2e\auth-access-control.spec.ts:127:7
```
