...
- Name: Purchase and Loyalty Flow >> should not accrue loyalty points for customer with loyalty disabled
- Location: C:\Users\USER\Downloads\ChainSync Directory\ChainSyncManager\test\e2e\purchase-loyalty-flow.spec.ts:73:3
...
Call log:
  - waiting for locator('input[name="email"]')
    ...
    at C:\Users\USER\Downloads\ChainSync Directory\ChainSyncManager\test\e2e\purchase-loyalty-flow.spec.ts:75:5
```
