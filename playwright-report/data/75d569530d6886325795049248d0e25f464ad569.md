...
- Name: Purchase and Loyalty Flow >> should accrue correct number of loyalty points based on transaction amount
- Location: C:\Users\USER\Downloads\ChainSync Directory\ChainSyncManager\test\e2e\purchase-loyalty-flow.spec.ts:45:3
...
Call log:
  - waiting for locator('input[name="email"]')
    ...
    at C:\Users\USER\Downloads\ChainSync Directory\ChainSyncManager\test\e2e\purchase-loyalty-flow.spec.ts:47:5
```
