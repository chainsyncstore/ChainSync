...
- Name: Authentication and Access Control >> Access Control >> only admin should be able to create new users
- Location: C:\Users\USER\Downloads\ChainSync Directory\ChainSyncManager\test\e2e\auth-access-control.spec.ts:102:5
...
Call log:
  - waiting for locator('input[name="email"]')
    ...
    at C:\Users\USER\Downloads\ChainSync Directory\ChainSyncManager\test\e2e\auth-access-control.spec.ts:104:7
```
