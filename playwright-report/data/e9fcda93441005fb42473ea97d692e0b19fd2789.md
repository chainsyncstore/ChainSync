...
- Name: Authentication and Access Control >> Authentication >> should allow login as customer
- Location: C:\Users\USER\Downloads\ChainSync Directory\ChainSyncManager\test\e2e\auth-access-control.spec.ts:15:7
...
Call log:
  - waiting for locator('input[name="email"]')
    ...
    at C:\Users\USER\Downloads\ChainSync Directory\ChainSyncManager\test\e2e\auth-access-control.spec.ts:16:9
```
