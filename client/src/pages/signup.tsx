...
const PasswordRequirement = ({ meets, label }: { meets: boolean; label: string }) => (
  <div className="flex items-center mt-1">
    ...
    <span className={cn('text-xs', meets ? 'text-green-600' : 'text-red-600')}>{label}</span>
  </div>
);
    ...
    <div className="min-h-screen w-full flex flex-col items-center bg-gradient-to-b from-neutral-100 to-white p-4 overflow-y-auto">
      <div className="w-full max-w-xl my-8">
        ...
        <div className="mb-6">
          <Link
            href="/"
            className="text-sm font-medium text-neutral-500 hover:text-neutral-800 flex items-center"
          >
        ...
        <div className="mb-6 text-center">
          <h1 className="text-3xl font-bold text-neutral-800">Create Your ChainSync Account</h1>
          ...
          >
            <div className="p-4 bg-primary/10 rounded-md border border-primary/20">
              ...
              <p className="text-sm mt-1 text-neutral-600">
                {formData.plan === 'basic' &&
                  'Perfect for single-store operations. Includes inventory management and basic analytics.'}
                {formData.plan === 'pro' &&
                  'Ideal for growing businesses with up to 10 store locations. Enhanced analytics and AI features.'}
                {formData.plan === 'enterprise' &&
                  'Custom solution for large operations with 10+ stores. Includes dedicated support and premium SLA.'}
              </p>
              {referralCode && formData.plan !== 'enterprise' && (
