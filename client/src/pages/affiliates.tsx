      ...
      <AppShell>
        ...
        <div className="mb-6">
          ...
          <p className="text-neutral-500 mt-1">
            Earn commission by referring new users to ChainSync
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-neutral-500 mt-2">
              Earn 10% commission on referred users' subscriptions for 12 months
            </p>
          </div>
            ...
            <Card className="p-4">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-sm text-gray-500">
                  Share your unique link with potential customers
                </p>
              </div>
            </Card>
            <Card className="p-4">
          ...
          {isRegistering ? (
            <Card className="w-full max-w-md mx-auto">
              <CardHeader>
                ...
                <CardDescription>Sign up to join our affiliate program</CardDescription>
              </CardHeader>
              <CardContent>
                <Form {...signupForm}>
                    ...
                    <div className="pt-2">
                      <Button type="submit" className="w-full" disabled={signupMutation.isPending}>
                        {signupMutation.isPending ? (
                          <>
                            <RefreshCwIcon className="mr-2 h-4 w-4 animate-spin" /> Creating
                            Account...
                          </>
                        ) : (
                          <>Create Account</>
            ...
            <Card className="w-full max-w-md mx-auto">
              <CardHeader>
                ...
                <CardDescription>Log in to access your affiliate dashboard</CardDescription>
              </CardHeader>
              <CardContent>
                <Form {...loginForm}>
              ...
              <CardFooter>{/* Removed "Don't have an account? Sign up" button */}</CardFooter>
            </Card>
          )}
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  When you share your unique referral link and someone signs up through it, they
                  receive a 10% discount on their subscription for 12 months. You earn 10%
                  commission on all their payments for 12 months.
                </p>
              </div>
              <div>
                <h3 className="font-medium">Commission Structure</h3>
                <p className="text-sm text-gray-600 mt-1">
                  10% commission on all subscription payments made by your referred users for 12
                  months.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Paystack for Nigerian affiliates and Flutterwave for international users. Minimum
                  payout is ₦10,000 or $10.
                </p>
              </div>
              <div>
