  ...
  return (
    <>
      <div className="relative">
        <div
          className={`flex gap-2 transition-all duration-300 ${showSuccess ? 'bg-green-50 border-green-300' : ''}`}
        >
          ...
          <Button onClick={handleScan} disabled={!barcode.trim() || disabled || isScanning}>
            {isScanning ? (
