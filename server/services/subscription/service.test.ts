...
describe('SubscriptionService', () => {
  ...
  describe('createSubscription', () => {
    ...
    it('should throw error when user does not exist', async () => {
      ...
      await expect(subscriptionService.createSubscription(validSubscriptionData)).rejects.toThrow(
        SubscriptionServiceErrors.USER_NOT_FOUND.message
      );
    });
    ...
    it('should throw error when active subscription already exists', async () => {
      ...
      await expect(subscriptionService.createSubscription(validSubscriptionData)).rejects.toThrow(
        SubscriptionServiceErrors.DUPLICATE_SUBSCRIPTION.message
      );
    });
  ...
  describe('updateSubscription', () => {
    ...
    it('should validate status transitions', async () => {
      ...
      await expect(
        subscriptionService.updateSubscription(subscriptionId, invalidUpdate)
  ...
  describe('cancelSubscription', () => {
    ...
    it('should throw error when subscription does not exist', async () => {
      ...
      await expect(subscriptionService.cancelSubscription(subscriptionId, reason)).rejects.toThrow(
        SubscriptionServiceErrors.SUBSCRIPTION_NOT_FOUND.message
      );
    });
    ...
    it('should throw error when subscription is not active', async () => {
      ...
      await expect(subscriptionService.cancelSubscription(subscriptionId, reason)).rejects.toThrow(
        SubscriptionServiceErrors.INVALID_CANCELLATION.message
      );
    });
  });
  ...
  describe('processWebhook', () => {
    ...
    it('should process Paystack subscription create webhook', async () => {
      ...
      jest.spyOn(subscriptionService as any, 'processPaystackWebhook').mockResolvedValue(true);

      const result = await subscriptionService.processWebhook(webhookData);

      // Check that validation was called
      expect(
        require('@shared/schema-validation').subscriptionValidation.webhook
      ).toHaveBeenCalled();
    ...
    it('should handle Flutterwave webhooks', async () => {
      ...
      jest.spyOn(subscriptionService as any, 'processFlutterwaveWebhook').mockResolvedValue(true);
    ...
    it('should throw error for unsupported provider', async () => {
      ...
      await expect(subscriptionService.processWebhook(unsupportedWebhook)).rejects.toThrow(
  ...
  describe('validateSubscriptionAccess', () => {
    ...
    it('should return true when user has required plan', async () => {
      ...
      const result = await subscriptionService.validateSubscriptionAccess(
        userId,
