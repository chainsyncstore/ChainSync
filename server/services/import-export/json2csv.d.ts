...
declare module 'json2csv' {
  ...
  export function parse<T>(data: T[], options: Json2CsvOptions, callback: (err: Error | null, csv: string) => void): void;
  ...
  export function stringify<T>(data: T[], options: Json2CsvOptions, callback: (err: Error | null, csv: string) => void): void;
