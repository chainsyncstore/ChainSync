...
describe('LoyaltyService', () => {
  ...
  describe('Unit Tests', () => {
    ...
    it('should throw validation error for invalid program data', async () => {
      ...
      // Act & Assert
      await expect(service.createLoyaltyProgram(invalidData as any))
        .rejects
    ...
    it('should handle database errors gracefully', async () => {
      ...
      // Act & Assert
      await expect(service.createLoyaltyProgram(programData))
        .rejects
        .toThrow('Failed to create loyalty program');
  ...
  describe('Integration Tests', () => {
    ...
    it('should handle error conditions', async () => {
      ...
      await expect(service.getLoyaltyProgramById('non-existent-id'))
        .rejects
        .toThrow('Loyalty program not found');
      
      // Test for invalid enrollment (non-existent program)
      const testCustomer = await createTestCustomer();
      await expect(service.enrollCustomer({
        customerId: testCustomer.id,
      ...
      await expect(service.enrollCustomer({
        ...
        .rejects
        .toThrow('Customer is already enrolled');
    });
  });
  ...
  describe('Validation', () => {
    ...
    it('should validate program data', () => {
      ...
      expect(() => testProgramSchema.parse({
        ...validData,
        name: 'A' // Too short
      })).toThrow();
