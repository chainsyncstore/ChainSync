...
exports.validateApiKeySecurely = validateApiKeySecurely;
exports.extractAndValidateApiKey = extractAndValidateApiKey;
exports.generateApiKey = generateApiKey;
exports.isOriginAllowed = isOriginAllowed;
const crypto_1 = __importDefault(require("crypto"));
const logging_1 = require("../../src/logging");
// Get centralized logger for auth utilities
const logger = (0, logging_1.getLogger)().child({ component: 'auth-utils' });
/**
...
function validateApiKeySecurely(providedKey, validKeys) {
    ...
    return validKeys.some(validKey => crypto_1.default.timingSafeEqual(Buffer.from(providedKey), Buffer.from(validKey)));
}
/**
...
function generateApiKey(prefix = 'csk') {
    const randomBytes = crypto_1.default.randomBytes(24).toString('base64url');
