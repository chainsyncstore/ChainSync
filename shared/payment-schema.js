import { pgTable, text, decimal, jsonb, serial, timestamp, boolean } from "drizzle-orm/pg-core"; // Removed integer, unique
import { createInsertSchema } from "drizzle-zod"; // Removed createSelectSchema
