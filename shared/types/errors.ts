...
export enum ErrorCode {
  ...
  LOYALTY_ALREADY_ENROLLED = 'LOYALTY_ALREADY_ENROLLED', // Added
  ...
  LOYALTY_INVALID_POINTS = 'LOYALTY_INVALID_POINTS', // Added
  LOYALTY_TRANSACTION_NOT_FOUND = 'LOYALTY_TRANSACTION_NOT_FOUND', // Added
  LOYALTY_TIER_NOT_FOUND = 'LOYALTY_TIER_NOT_FOUND', // Added
  // INVALID_OPERATION for loyalty can use the generic INVALID_OPERATION or a more specific one if needed

  // HTTP Status Codes (some might overlap with more specific custom errors)
  ...
  INVALID_OPERATION = 'INVALID_OPERATION', // General invalid operation
  INVALID_FORMAT = 'INVALID_FORMAT',
  ...
  DATABASE_ERROR = 'DATABASE_ERROR', // General DB Error
  ...
  // INVALID_FILE is already present
  // FILE_TOO_LARGE is already present

  // Middleware specific (potentially)
  AUTHENTICATION = 'AUTHENTICATION', // Added from server/middleware/types/error.ts
  ...
  INVALID_EMAIL = 'INVALID_EMAIL', // Consider if covered by general validation
  NO_PAYMENT_PROVIDER = 'NO_PAYMENT_PROVIDER',
  PAYMENT_ERROR = 'PAYMENT_ERROR',
  PAYMENT_TRACKING_ERROR = 'PAYMENT_TRACKING_ERROR',
  INVALID_WEBHOOK = 'INVALID_WEBHOOK',
  ANALYTICS_ERROR = 'ANALYTICS_ERROR', // Or move to a new category
  INVALID_REFUND = 'INVALID_REFUND',
  REFUND_FAILED = 'REFUND_FAILED',
  FLUTTERWAVE_TRANSACTION_FAILED = 'FLUTTERWAVE_TRANSACTION_FAILED',
  FLUTTERWAVE_TRANSACTION_ERROR = 'FLUTTERWAVE_TRANSACTION_ERROR',

  // Additional error codes referenced in the codebase
  VALIDATION_FAILED = 'VALIDATION_FAILED', // General validation failure
