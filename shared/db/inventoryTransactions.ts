import { pgTable, serial, integer, text, timestamp, decimal, uniqueIndex, pgEnum, jsonb } from "drizzle-orm/pg-core";
...
export const inventoryTransactionTypeEnum = pgEnum("inventory_transaction_type", [
  'purchase', 'sale', 'return', 'damage', 'loss', 'transfer', 'adjustment', 'count', 'receive'
]);
