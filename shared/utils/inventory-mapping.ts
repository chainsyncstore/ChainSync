 ...
 */
export function inventoryItemFromDatabaseFields<T extends Record<string, unknown>>(
  dbItem: T
): Partial<Inventory> {
 ...
 */
export function batchInventoryToDatabaseFields(
  batch: Partial<BatchInventory>
 ...
 */
export function batchInventoryFromDatabaseFields<T extends Record<string, unknown>>(
  dbBatch: T
): Partial<BatchInventory> {
 ...
 */
export function inventoryTransactionToDatabaseFields(
 ...
 */
export function inventoryTransactionFromDatabaseFields<T extends Record<string, unknown>>(
  dbTransaction: T
