 ...
 */
export function loyaltyMemberToDatabaseFields(
  member: Partial<LoyaltyMember>
 ...
 */
export function loyaltyMemberFromDatabaseFields<T extends Record<string, unknown>>(
  dbMember: T
): Partial<LoyaltyMember> {
 ...
 */
export function loyaltyProgramToDatabaseFields(
 ...
 */
export function loyaltyProgramFromDatabaseFields<T extends Record<string, unknown>>(
  dbProgram: T
): Partial<LoyaltyProgram> {
 ...
 */
export function loyaltyTransactionToDatabaseFields(
 ...
 */
export function loyaltyTransactionFromDatabaseFields<T extends Record<string, unknown>>(
  dbTransaction: T
): Partial<LoyaltyTransaction> {
